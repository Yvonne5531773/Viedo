<template>
	<div class="search">
		<form action="//search.bilibili.com/all" id="searchform">
			<input name="keyword" type="text" class="search-keyword" id="search-keyword" autocomplete="off" accesskey="s" x-webkit-speech="" x-webkit-grammar="builtin:translate" placeholder="搜索..." data-recommend="av8509845">
